...
public abstract class IMDBPage<T extends SourceInfo> extends HTMLAnalyzeUtil {
	...
	protected String loadPage(String url) {
		HttpRequest req = HttpRequest.fromURL(url, IMDBUtil.getHost(), 80);
