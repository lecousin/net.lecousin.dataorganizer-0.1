...
public enum Local {
	...
	Cover_back_pictures("Album covers back", "Dessous de couverture de l'album"),
	Cover_front_picture("Album cover front", "Dessus de couverture de l'album"),
	Cover_front_pictures("Album covers front", "Dessus de couverture de l'album"),
	...
	Other_album_pictures("Other album pictures", "Autres images de l'album"),
