package net.lecousin.dataorganizer.allcdcovers.retriever.movie;
...
public class AllCDCoversMoviePlugin implements InfoRetrieverPlugin {

	public AllCDCoversMoviePlugin() {
	}
	...
	public List<SearchResult> search(String name, WorkProgress progress, int work) {
		return Search.search(name, Search.MOVIES, progress, work);
	}
}
