...
public class MediaCenterActionProvider_Audio implements ActionProvider {

	public MediaCenterActionProvider_Audio() {
	}
	...
	public List<Action> getActions(List<Data> data) {
		...
		list.add(new ActionAdd(data, Media.TYPE_MUSIC));
		return list;
	}
